...
import CasDiffTool from "@/components/calculators/CasDiffTool";

export const metadata: Metadata = {
  title: "Financial Tools",
  description:
    "General-purpose financial calculators for NRIs: currency impact, SIP/mutual fund XIRR, FD/RD maturity, loan prepayment impact, a tax treatment comparison across common investment types, USD/INR FX rate history, and a CAS statement diff tool.",
};
